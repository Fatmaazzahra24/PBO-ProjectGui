...
public class JadwalKelasGym {
    ...
    private static JTextField txtIDKelas, txtNamaKelas, txtJamKelas;
    private static JComboBox<String> cbHari, cbInstruktur;
    private static JTable tableJadwal;
    ...
    public static void main(String[] args) {
        ...
        frame = new JFrame("Form 3 - Jadwal Kelas Gym");
        ...
        txtIDKelas = new JTextField("Auto"); 
    ...
    private static void loadInstruktur() {
        ...
        try {
            ...
            while (rs.next()) {
                model.addRow(new Object[]{
                    rs.getInt("id_kelas"), rs.getString("nama_kelas"), rs.getString("hari"), rs.getString("jam_kelas"), rs.getString("nama_instruktur"), rs.getInt("id_instruktur")
                });
            }
            conn.close();
        } catch (Exception ex) {
            JOptionPane.showMessageDialog(frame, "Gagal memuat data jadwal!\n" + ex.getMessage(),"Error", JOptionPane.ERROR_MESSAGE);
        }
    }
    ...
    private static void pilihBaris() {
